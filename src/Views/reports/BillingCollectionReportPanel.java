...
public class BillingCollectionReportPanel extends JPanel {
    ...
    private void generateReport() {
        ...
        SwingWorker<List<BIllingCollectionReport>, Void> worker = new SwingWorker<>() {
            @Override
            ...
            protected void done() {
                ...
                try {
                    ...
                    if (data == null || data.isEmpty()) {
                        JOptionPane.showMessageDialog(BillingCollectionReportPanel.this, "No billing data found for the selected date range.", "No Data", JOptionPane.INFORMATION_MESSAGE);
                    ...
                    JOptionPane.showMessageDialog(BillingCollectionReportPanel.this, "Error generating report:\n" + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                    e.printStackTrace();
                }
            }
        };
