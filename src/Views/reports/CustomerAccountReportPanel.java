...
public class CustomerAccountReportPanel extends JPanel {
    ...
    private void generateReport() {
        ...
        SwingWorker<List<CustomerAccountReport>, Void> worker = new SwingWorker<List<CustomerAccountReport>, Void>() {
            @Override
            ...
            protected void done() {
                ...
                try {
                    ...
                    if (data == null || data.isEmpty()) {
                        JOptionPane.showMessageDialog(CustomerAccountReportPanel.this,
